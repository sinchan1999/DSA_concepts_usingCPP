...
// FOR DETAILS:   https://www.geeksforgeeks.org/find-the-point-where-a-function-becomes-negative/
...
// Let's take an example function as f(x) = x^2 - 10*x - 20 Note that
// f(x) can be any monotonically increasing function

int f(int x) { return (x*x - 10*x -100); } // ***TUNE THIS AND SEE THE CHANGE MORE neg. later we get the first positive!!!
