...
It works better than Binary Search for bounded arrays, and also when the element to be searched 
is closer to the first element.

FOR MORE DETAILS:  https://www.geeksforgeeks.org/exponential-search/
*/
